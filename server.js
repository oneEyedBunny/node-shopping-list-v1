...
// we import the ShoppingList & Recipes model, which we'll
...
//creating sample receipes to see if get request is working
Recipes.create('chocolate milk', ['cocoa', 'milk', 'sugar']);
Recipes.create('chai tea', ['chai mix', 'milk', 'sugar']);
Recipes.create('peach lemonaide', ['peachs', 'lemonaide mix', 'sugar']);
...
//get request to obtain an object with recipe data
